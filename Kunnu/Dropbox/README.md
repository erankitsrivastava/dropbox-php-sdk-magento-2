Dropbox Magento 2 Module for PHP
======================================================
Converted from the Kunnu-Dropbox SDK.

An unofficial Magento 2 Module, to work with the [Dropbox API v2](https://www.dropbox.com/developers/documentation/http/documentation).
